...
Source Database       : dk_project

Target Server Type    : MYSQL
Target Server Version : 50721
File Encoding         : 65001

Date: 2018-08-21 10:24:04
*/
...
CREATE TABLE `issue` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `UQE_issue_repo_index` (`repo_id`,`issue_index`) USING BTREE,
  KEY `IDX_issue_repo_id` (`repo_id`) USING BTREE
...
CREATE TABLE `issue_user` (
  ...
  KEY `IDX_issue_user_repo_id` (`repo_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `label` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IDX_label_repo_id` (`repo_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
