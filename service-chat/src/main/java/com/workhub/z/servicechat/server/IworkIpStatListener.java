 ...
 *
 */
public class IworkIpStatListener implements IpStatListener {
    private static Logger log = LoggerFactory.getLogger(IworkIpStatListener.class);

    public static final IworkIpStatListener me = new IworkIpStatListener();

    /**
     *
     */
    private IworkIpStatListener() {
    }
