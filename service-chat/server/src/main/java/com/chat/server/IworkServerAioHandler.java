 ...
 */
public class IworkServerAioHandler implements ServerAioHandler {
     ...
     */
    @Override
    public IworkPacket decode(ByteBuffer buffer, ChannelContext channelContext) throws AioDecodeException {
    ...
    public void handler(Packet packet, ChannelContext channelContext) throws Exception {
        ...
        if (body != null) {
            ...
            IworkPacket resppacket = new IworkPacket();
            resppacket.setBody(("收到了你的消息，你的消息是:" + str).getBytes(IworkPacket.CHARSET));
